...
export default function ProjectPicker() {
  ...
  return (
    <div className={`min-h-screen bg-editor-bg relative overflow-hidden flex flex-col p-8 sm:p-12 lg:p-20 ${isExiting ? "page-fade-out" : "page-fade-in"}`}>
      {/* Background decorations */}
      <div className="absolute top-[-10%] right-[-5%] w-[40%] h-[40%] bg-blue-600/10 blur-[120px] rounded-full pointer-events-none glow-orb-1" />
      <div className="absolute bottom-[-10%] left-[-5%] w-[40%] h-[40%] bg-purple-600/10 blur-[120px] rounded-full pointer-events-none glow-orb-2" />
      ...
      <div className="z-10 max-w-6xl w-full mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div>
            <h1 className="text-4xl font-bold text-white tracking-tight mb-2 flex items-center gap-3">
              <Code2 className="text-blue-500 hover:rotate-12 transition-transform duration-300" size={32} />
              Your Workspaces
            </h1>
          ...
          {/* Create new */}
          <div className="flex items-center gap-3 bg-editor-sidebar/50 backdrop-blur-md border border-editor-border/50 p-1.5 rounded-xl shadow-lg focus-within:border-indigo-500/50 focus-within:shadow-[0_0_20px_rgba(99,102,241,0.15)] transition-all duration-300">
            <input
        ...
        {projects.length === 0 ? (
          <div className="flex flex-col items-center justify-center p-20 border border-dashed border-editor-border/50 rounded-2xl bg-editor-sidebar/30 backdrop-blur-sm">
            <FolderOpen className="text-editor-muted/50 mb-4 animate-pulse" size={48} />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {projects.map((p, index) => (
              <div
                ...
                className="animate-card-entrance group relative bg-editor-sidebar/60 backdrop-blur-xl border border-editor-border/50 rounded-2xl p-6 cursor-pointer hover:border-blue-500/50 hover:bg-editor-sidebar/80 transition-all duration-300 shadow-lg hover:shadow-blue-500/10 hover:-translate-y-1 overflow-hidden"
              >
