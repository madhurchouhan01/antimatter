        ...
        >
          ...
          <div className="flex border-b border-white/[0.06] bg-white/[0.01]">
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-1.5 py-3 text-[12px] font-semibold tracking-wide transition-all duration-250 ${activeTab === "provider"
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-1.5 py-3 text-[12px] font-semibold tracking-wide transition-all duration-250 ${activeTab === "memories"
                  ? "text-editor-accent border-b-2 border-editor-accent bg-editor-accent/[0.02]"
                  : "text-white/40 hover:text-white border-b-2 border-transparent"
                }`}
            >
                      ...
                      >
                        <div className="flex items-start justify-between gap-3">
                          ...
                          <button
                            ...
                            className={`shrink-0 p-1.5 rounded-lg transition-colors opacity-0 group-hover:opacity-100 cursor-pointer ${mem.__isDummy
